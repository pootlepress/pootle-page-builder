...
class pootle_page_builder_one_pager_Admin {
	...
	public function content_block_tabs( $tabs ) {
		$tabs[ $this->token ] = array(
			'label'    => __( 'One Pager', 'pootle-page-builder' ),
			'priority' => 5,
		);
	...
	public function admin_init() {
		add_meta_box( 'sfxtp-menu-items', __( 'One pager menu item', 'pootle-page-builder' ), array(
			$this,
			'menu_meta_box'
		...
		<div class="ppb-1pager-div" id="ppb-1pager-div">
			...
			<span class="add-to-menu">
				<input type="submit"<?php wp_nav_menu_disabled_check( $nav_menu_selected_id ); ?>
							 class="button-secondary submit-add-to-menu right" value="<?php esc_attr_e( 'Add to Menu', 'pootle-page-builder' ); ?>"
	...
	public function content_block_fields( $fields ) {
		$fields[ $this->token . '-section_name' ] = array(
			'name'        => __( 'Section name', 'pootle-page-builder' ),
			'placeholder' => __( 'Name your section', 'pootle-page-builder' ),
			'type'        => 'text',
			'priority'    => 1,
			'tab'         => $this->token,
		);
		$fields[ $this->token . '-offset' ]       = array(
			'name'     => __( 'Navigation offset', 'pootle-page-builder' ),
			'type'     => 'number',
			'priority' => 2,
			'tab'      => $this->token,
		);
