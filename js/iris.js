...
(function ($, undef) {
    ...
    Iris = {
        ...
        _addInputListeners: function (input) {
            var self = this,
                debounceTimeout = 100, //CHANGED by Alan
                callback = function (event) {
                    ...
                    if (color.error) {
                        ...
                        // CHANGED by Alan to set color when text box has rgba value
                        if (color._color !== self._color._color || color._alpha !== self._color._alpha) {
                            // let's not do this on keyup for hex shortcodes
                            if (!( event.type === 'keyup' && val.match(/^[0-9a-fA-F]{3}$/) )) {
                                // use input.val() instead of color.toString()
                                self._setOption('color', input.val());
                            }
                        }
                    }
                };
            ...
            switch (key) {
                case 'color':
                    ...
                    if (newColor.error) {
                        ...
                        // CHANGED by Alan : if this line of code is executed, it will overwrite the rgba value with hex value into options
