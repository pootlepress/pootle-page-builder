...
jQuery(function( $ ) {
    ...
    $.widget( "ppb.ppbDialog", {
        ...
        _createWrapper: function() {
            this.uiDialog = $("<div>")
                .addClass( "ppb-dialog ppb-widget ppb-widget-content ui-corner-all ui-front " +
        ...
        _createTitlebar: function() {
            ...
            this.uiDialogTitlebar = $( "<div>" )
                .addClass( "ppb-dialog-titlebar ppb-widget-header ui-corner-all ui-helper-clearfix" )
        ...
        _createButtonPane: function() {
            this.uiDialogButtonPane = $( "<div>" )
                .addClass( "ppb-dialog-buttonpane ppb-widget-content ui-helper-clearfix" );
        ...
        _createOverlay: function() {
            ...
            this.overlay = $( "<div>" )
                .addClass( "ppb-widget-overlay ui-front" )
                .appendTo( this._appendTo() );
            this._on( this.overlay, {
                mousedown: "_keepFocus"
            });
            this.document.data( "ppb-dialog-overlays",
                (this.document.data( "ppb-dialog-overlays" ) || 0) + 1 );
        },
