		...
		$dlog
			...
			.append(
				$( '<div/>' ).attr( 'id', 'shramee-unsplash-content' )
					...
					.append(
						$( '<p/>' ).html( 'All free photos are from <a href="https://unsplash.com/">Unsplash.com</a> and can be used for free' )
					)
					.append(
